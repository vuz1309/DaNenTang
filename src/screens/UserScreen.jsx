        ...
        <ScrollView
            ...
            <TouchableOpacity
                ...
                <>
                    ...
                    {isOwner && (
                        <TouchableOpacity style={styles.changeCover} onPress={toggleChangeImg}>
                            <VectorIcon
                                name="camera"
                                type="FontAwesome5"
                    ...
                    {isOwner && (
                        <TouchableOpacity style={styles.changeImg} onPress={toggleChangeImg}>
                            <VectorIcon
                                name="camera"
                                type="FontAwesome5"
                                color={Themes.COLORS.grey}
                    ...
                    {Number(userInfo.online) && !isOwner && <View style={styles.isOnline}/>}
                </>
            </TouchableOpacity>
