...
const ProfileSetting = ({route}) => {
  ...
  const Block = async () => {
    try {
      ...
      ToastAndroid.show(
        'Chặn ' + `${route.params.user.username}` + ' thành công',
        ToastAndroid.SHORT,
      );
      store.dispatch(
  ...
  return (
    <View style={{flex: 1, backgroundColor: Colors.background}}>
      ...
      <View style={styles.list}>
        ...
        <Pressable style={styles.option} onPress={GoToSearch}>
          <VectorIcon
            name="search1"
            type="AntDesign"
            size={28}
      ...
      <View style={{backgroundColor: Colors.white, paddingLeft: 5}}>
        <View>
          <Text
            ...
            Liên kết đến trang cá nhân của {route.params.user.username}
          </Text>
          ...
          <Text
            ...
            Liên kết riêng của {route.params.user.username} trên facebook
          </Text>
